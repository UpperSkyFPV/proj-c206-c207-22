 ...
 */
class AddUserToChatScene : public eng::Scene {
public:
    AddUserToChatScene(shared_ptr<AppState> s) : state{s} {}
    ...
    static std::shared_ptr<AddUserToChatScene> make(shared_ptr<AppState> s) {
        return std::make_shared<AddUserToChatScene>(s);
    }
